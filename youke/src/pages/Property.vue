        ...
        <el-card>
            ...
            <el-row style="margin-bottom: 10px">
                <el-col :span="18" style="line-height: 40px">
                    ...
                    <el-button type="danger" size="small" style="margin-right: 10px" @click="del">
                    ...
                    <el-dropdown size="small" split-button type="primary" style="margin-right: 10px">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item>批量导入模板</el-dropdown-item>
                            <el-dropdown-item :divided="state1">导出资产</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                    <el-dropdown size="small" split-button type="primary">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item :divided="state1">打印资产卡片</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-col>
                <el-col :span="6">
                            ...
                            <el-row>
                                <el-form label-width="80px" :model="form1">
                                    <el-col :span="8">
                                        <el-form-item label="资产条码">
                                            <el-input :disabled="true" placeholder="自动生成"
                                                      v-model="form1.barcode"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-form-item label="资产名称">
                                            <el-input placeholder="资产名称" v-model="form1.name"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-form-item label="资产类型">
                                            <el-select v-model="form1.type" placeholder="资产类型">
                                                <el-option
                                    ...
                                    <el-col :span="8">
                                        <el-form-item label="规格型号">
                                            <el-input placeholder="规格型号" v-model="form1.model"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-form-item label="SN号">
                                    ...
                                    <el-col :span="8">
                                        <el-form-item label="计量单位">
                                            <el-input placeholder="计量单位" v-model="form1.unit"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-form-item label="金额">
                                            <el-input placeholder="金额" v-model="form1.price"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-form-item label="使用公司">
                                            <el-select placeholder="使用公司" v-model="form1.company">
                                                <el-option
                                    ...
                                    <el-col :span="8">
                                        <el-form-item label="使用部门">
                                            <el-select placeholder="使用部门" v-model="form1.department">
                                                <el-option
                                    ...
                                    <el-col :span="8">
                                        <el-form-item label="使用人">
                                            <el-select placeholder="使用人" v-model="form1.person">
                                                <el-option
                                    ...
                                    <el-col :span="8">
                                        <el-form-item label="管理员">
                                            <el-select v-model="form1.administrator" placeholder="管理员">
                                                <el-option
                                    ...
                                    <el-col :span="8">
                                        <el-form-item label="存放地点">
                                            <el-select v-model="form1.address" placeholder="存放地点">
                                                <el-option
                                    ...
                                    <el-col :span="8">
                                        <el-form-item label="使用期限">
                                            <el-input placeholder="使用期限(月)" v-model="form1.deadline"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-form-item label="来源">
                                            <el-select v-model="form1.source" placeholder="来源">
                                                <el-option
